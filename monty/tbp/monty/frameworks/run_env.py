...
def setup_env(monty_logs_dir_default: str = "~/tbp/results/monty/", root_dir_default: str = "~/tbp/"):
    """Setup environment variables for Monty.

    Args:
        monty_logs_dir_default (str): Default directory for Monty logs.
        root_dir_default (str): Default root directory for Monty.
    """
    ...
    if monty_data_dir is None:
        monty_data_dir = os.path.expanduser(str(Path(root_dir_default)/"data/"))
